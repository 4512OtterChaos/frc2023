...
public final class ArmConstants{
    ...
    public static final Rotation2d kShoulderAngleOffset = new Rotation2d().fromDegrees(53.75);
    ...
    //----- Wrist
    public static final Rotation2d kWristAngleOffset = new Rotation2d().fromDegrees(9);
